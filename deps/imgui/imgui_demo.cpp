...
void ImGui::ShowTestWindow(bool* p_opened)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Multi-component Widgets"))
        {
            ...
            static float vec4_t[4] = { 0.10f, 0.20f, 0.30f, 0.44f };
            static int vec4i[4] = { 1, 5, 100, 255 };

            ImGui::InputFloat2("input float2", vec4_t);
            ImGui::DragFloat2("drag float2", vec4_t, 0.01f, 0.0f, 1.0f);
            ImGui::SliderFloat2("slider float2", vec4_t, 0.0f, 1.0f);
            ImGui::DragInt2("drag int2", vec4i, 1, 0, 255);
            ImGui::InputInt2("input int2", vec4i);
            ImGui::SliderInt2("slider int2", vec4i, 0, 255);
            ImGui::Spacing();

            ImGui::InputFloat3("input float3", vec4_t);
            ImGui::DragFloat3("drag float3", vec4_t, 0.01f, 0.0f, 1.0f);
            ImGui::SliderFloat3("slider float3", vec4_t, 0.0f, 1.0f);
            ImGui::DragInt3("drag int3", vec4i, 1, 0, 255);
            ImGui::InputInt3("input int3", vec4i);
            ImGui::SliderInt3("slider int3", vec4i, 0, 255);
            ImGui::Spacing();

            ImGui::InputFloat4("input float4", vec4_t);
            ImGui::DragFloat4("drag float4", vec4_t, 0.01f, 0.0f, 1.0f);
            ImGui::SliderFloat4("slider float4", vec4_t, 0.0f, 1.0f);
