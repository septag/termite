...
namespace bx
{
    ...
    ///
    template<typename Ty>
    Ty atomicInc(volatile Ty* _ptr);

    ///
    template<typename Ty>
    Ty atomicDec(volatile Ty* _ptr);

    ///
    template<typename Ty>
    Ty atomicAND(volatile Ty* _ptr, Ty _value);

    ///
    template<typename Ty>
    Ty atomicOR(volatile Ty* _ptr, Ty _value);

    ///
    template<typename Ty>
    Ty atomicXOR(volatile Ty* _ptr, Ty _value);
