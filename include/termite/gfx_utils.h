...
namespace termite
{
    ...
    TERMITE_API void blitToBackbuffer(uint8_t viewId, TextureHandle texture);
    TERMITE_API void blitToFramebuffer(uint8_t viewId, FrameBufferHandle framebuffer, BackbufferRatio::Enum ratio, 
