...
namespace termite
{
    ...
    C11_DEFINE_FLAG_TYPE(gfxResetFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxDebugFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxCapsFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxTextureFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxViewFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxSubmitFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxStencil);
    ...
    C11_DEFINE_FLAG_TYPE(gfxClearFlag);
    ...
    C11_DEFINE_FLAG_TYPE(gfxBufferFlag);
